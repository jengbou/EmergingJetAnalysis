...
event_vars = [
    ...
    Var("HLT_HT430"           , "bool"  , 0 , ) , #HLT_HT430_DisplacedDijet40_DisplacedTrack_v (2017)
    Var("HLT_HT650"           , "bool"  , 0 , ) , #HLT_HT650_DisplacedDijet60_Inclusive_v (2017)
