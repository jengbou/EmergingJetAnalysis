...
private:
    ...
    std::unique_ptr< reco::PFJetCollection > scanJet_;
    std::unique_ptr< reco::TrackCollection > scanJetTracks_;
    std::unique_ptr< reco::TrackCollection > scanJetSelectedTracks_;
    std::unique_ptr< reco::VertexCollection > avrVerticesGlobalOutput_;
    std::unique_ptr< reco::VertexCollection > avrVerticesLocalOutput_;
    std::unique_ptr< reco::TrackCollection > avrVerticesRFTracksGlobalOutput_;
    std::unique_ptr< reco::TrackCollection > avrVerticesRFTracksLocalOutput_;
    std::unique_ptr< reco::VertexCollection > darkPionVertices_;
    std::unique_ptr< reco::VertexCollection > tkvfGlobalOutput_;
    std::unique_ptr< reco::VertexCollection > tkvfLocalOutput_;
...
EmJetAnalyzer::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    scanJet_ = std::unique_ptr< reco::PFJetCollection > ( new reco::PFJetCollection() );
    scanJetTracks_ = std::unique_ptr< reco::TrackCollection > ( new reco::TrackCollection() );
    scanJetSelectedTracks_ = std::unique_ptr< reco::TrackCollection > ( new reco::TrackCollection() );
    avrVerticesGlobalOutput_ = std::unique_ptr< reco::VertexCollection > ( new reco::VertexCollection() );
    avrVerticesLocalOutput_ = std::unique_ptr< reco::VertexCollection > ( new reco::VertexCollection() );
    avrVerticesRFTracksGlobalOutput_ = std::unique_ptr< reco::TrackCollection > ( new reco::TrackCollection() );
    avrVerticesRFTracksLocalOutput_ = std::unique_ptr< reco::TrackCollection > ( new reco::TrackCollection() );
    darkPionVertices_ = std::unique_ptr< reco::VertexCollection > ( new reco::VertexCollection() );
    tkvfGlobalOutput_ = std::unique_ptr< reco::VertexCollection > ( new reco::VertexCollection() );
    tkvfLocalOutput_ = std::unique_ptr< reco::VertexCollection > ( new reco::VertexCollection() );
    ...
    // Retrieve HLT info
    {
        ...
        // EXO-16-003 Triggers (2016)
        event_.HLT_HT250 = triggerfired(iEvent,trigResults,"HLT_HT250_DisplacedDijet40_DisplacedTrack_v");
        event_.HLT_HT350 = triggerfired(iEvent,trigResults,"HLT_HT350_DisplacedDijet40_DisplacedTrack_v");
        event_.HLT_HT400 = triggerfired(iEvent,trigResults,"HLT_HT400_DisplacedDijet40_Inclusive_v");
        event_.HLT_HT500 = triggerfired(iEvent,trigResults,"HLT_HT500_DisplacedDijet40_Inclusive_v");
        // 2017/2018 Displaced jets
        event_.HLT_HT430 = triggerfired(iEvent,trigResults,"HLT_HT430_DisplacedDijet40_DisplacedTrack_v");
        event_.HLT_HT650 = triggerfired(iEvent,trigResults,"HLT_HT650_DisplacedDijet60_Inclusive_v");

        // Emerging Jets Analysis Triggers (2016)
        ...
        // 2017
        event_.HLT_PFHT1050 = triggerfired(iEvent,trigResults,"HLT_PFHT1050_v");
    }
    ...
    iEvent.put(std::move(scanJet_), "scanJet"); // scanJet_
    iEvent.put(std::move(scanJetTracks_), "scanJetTracks"); // scanJetTracks_
    iEvent.put(std::move(scanJetSelectedTracks_), "scanJetSelectedTracks"); // scanJetSelectedTracks_
    iEvent.put(std::move(avrVerticesGlobalOutput_), "avrVerticesGlobalOutput"); // avrVerticesGlobalOutput_
    iEvent.put(std::move(avrVerticesLocalOutput_), "avrVerticesLocalOutput"); // avrVerticesLocalOutput_
    iEvent.put(std::move(avrVerticesRFTracksGlobalOutput_), "avrVerticesRFTracksGlobalOutput"); // avrVerticesRFTracksGlobalOutput_
    iEvent.put(std::move(avrVerticesRFTracksLocalOutput_), "avrVerticesRFTracksLocalOutput"); // avrVerticesRFTracksLocalOutput_
    iEvent.put(std::move(darkPionVertices_), "darkPionVertices"); // darkPionVertices_
    iEvent.put(std::move(tkvfGlobalOutput_), "tkvfGlobalOutput"); // tkvfGlobalOutput_
