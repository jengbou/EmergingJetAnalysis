...
WriteEventToOutput(const Event& event, emjet::OutputTree* otree)
{
  ...
  // Event-level variables, e.g. int, float, etc.
  {
    ...
    otree->HLT_PFHT1050                            = event.HLT_PFHT1050                           ;
    ...
    otree->HLT_HT430                               = event.HLT_HT430                              ;
    otree->HLT_HT650                               = event.HLT_HT650                              ;
