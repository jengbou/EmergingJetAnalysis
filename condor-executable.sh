...
# 7: NUM_FILES_PER_JOB - number of events per job
#
...
# CONDOR_MAXEVENTS : Set to $NUM_FILES_PER_JOB
# CONDOR_SKIPEVENTS : Set to $CONDOR_PROCESS*$NUM_FILES_PER_JOB
...
echo "NUM_FILES_PER_JOB: $NUM_FILES_PER_JOB"
...
let "SKIP_EVENTS = $CONDOR_PROCESS*$NUM_FILES_PER_JOB"
...
| sed -e s/CONDOR_MAXEVENTS/$NUM_FILES_PER_JOB/ \
